...
class Movie(models.Model):
    ...
    end_year = models.IntegerField(verbose_name='Год последнего выпуска', null=True, blank=True)
...
class ST88project(models.Model):
    title = models.CharField(max_length=100, verbose_name="Название")
    year = models.IntegerField(verbose_name="Год выпуска")
    end_year = models.IntegerField(verbose_name="Последний год выпуска", null=True, blank=True)
