    ...
    <div className="flex">
        <div className="w-5/6">
            <div className="grid grid-cols-3 gap-4">
                {movies.map(movie => {
                    return  (
                        <Link to='#' className="flex items-between md:flex-row md:max-w-xl border-custom bg-opacity-80 hover:ring-4 hover:ring-green-600 hover:shadow-2xl transition duration-100 ease-in-out transform hover:-translate-y-1 hover:scale-110 icons"> 
                            <img className="object-cover w-full h-96 md:h-auto md:w-48" src={movie.poster} alt={movie.title}/>
                            <div className="flex flex-col justify-around items-center text-center p-5 leading-normal">
