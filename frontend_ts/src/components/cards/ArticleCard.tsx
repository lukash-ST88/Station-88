  ...
  return (
    <CSSTransition key={props.index} timeout={5000} classNames="post">
      <div
        ...
        className="relative border-custom z-0 hover:z-10 hover:text-green-600 hover:ring-4 hover:ring-green-600 hover:cursor-pointer transition duration-100 ease-in-out lg:transform hover:lg:-translate-y-1 hover:lg:scale-110"
      >
