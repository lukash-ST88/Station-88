    ...
    return (
        <>
            <div className="flex flex-wrap justify-center gap-10 items-center p-5 bg-gradient-to-r from-st88-background via-st88-secondary to-st88-background">
              ...
              <div className="grid grid-cols-1 justify-center items-center gap-2 content-center border-2 py-3 px-6 lg:px-16 cursor-default bg-gradient-to-b from-st88-background via-st88-third to-st88-background min-h-[320px] min-w-[240px] text-center">
